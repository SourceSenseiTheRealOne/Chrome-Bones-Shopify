...
const Nav = () => {
  ...
  return (
    ...
    //     <Link href="/" passHref>
    //       <span className="text-lg pt-1 font-bold">Chrome Bones</span>
    //     </Link>
    //     <a
    //       href="https://github.com/bdoroshev/Shopify-NextJS-Tailwind"
    //       target="_blank"
    //       className="flex items-center font-bold sm:absolute top-1/2 left-1/2 sm:transform sm:-translate-x-1/2 sm:-translate-y-1/2 sm:mt-1"
    //     >
    //       {/* <FaGithub /> <span className="block ml-2">Github Repo</span> */}
    //     </a>
    //     <a
    ...
    <div className="absolute top-0 left-0 right-0 z-50 mt-5">
      <Navbar className="mx-auto max-w-screen-xl px-4 py-2 lg:px-8 lg:py-4 bg-black border-none">
        <div className="mx-auto flex items-center justify-between text-white">
          ...
          <div className="flex items-center gap-x-1">
            <Button
              variant="gradient"
              size="sm"
              className="hidden lg:inline-block bg-gradient-to-r from-amber-600 to-amber-800"
              onClick={() => setCartOpen(!cartOpen)}
            >
              Cart ({cartQuantity})
            </Button>
